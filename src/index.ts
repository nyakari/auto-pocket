...
export { clickAt, doubleClickAt, typeText, pressKey, releaseKey, moveMouse, getCursorPos, Button, Key } from './actions'
...
export type { MouseButton, MatchEvent, RuleAction, Rule, WatcherConfig, WatcherStatus } from './types'
